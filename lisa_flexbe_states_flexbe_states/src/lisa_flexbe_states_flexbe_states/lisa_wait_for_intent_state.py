...
from lisa_interaction_msgs.msg import  IntentMessage, IntentNotRecognizedMessage
...
class LisaWaitForIntentState(EventState):
    '''
    Wait for an intent to be published 
    ...
    -- wait_time 	float 	wait time out in sec (default 0 no timeout and wait indefinitely). 
    ...
    def __init__(self, context_id=None, 
        ...
        super(LisaWaitForIntentState, self).__init__(outcomes = ['intent_recognized', 'intent_not_recognized', 'preempt', 'timeouted', 'error'],
