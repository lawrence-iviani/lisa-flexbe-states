...
'''
class YesNoDialogueSM(Behavior):
    '''
    A yes No dialogue, used in different application
    '''


    def __init__(self):
        super(YesNoDialogueSM, self).__init__()
        self.name = 'Yes-No Dialogue'
    ...
    def create(self):
        ...
        _state_machine.userdata.question = 'Would you like to continue?'
        _state_machine.userdata.retry = 3
        ...
        with _state_machine:
            # x:416 y:26
            OperatableStateMachine.add('AskForYesNo',
